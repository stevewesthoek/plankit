...
export function KnowledgeSourcesPanel({
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900/70">
      ...
      <p className="text-slate-600 text-sm mb-6 dark:text-slate-300">Configured knowledge sources that are searched and read together through ChatGPT.</p>

      <form
        ref={addSourceFormRef}
        onSubmit={onAddSourceSubmit}
        className="border border-slate-200 rounded-lg p-4 mb-6 space-y-4 bg-slate-50 dark:border-slate-800 dark:bg-slate-950/50"
      >
        <div>
